...
do {  
?>
                           <option value="<?php echo $row_Recordset1['POLICESTATION_NAME']?>"><?php echo $row_Recordset1['POLICESTATION_NAME']?></option>
                           <?php
...
do {  
?>
     <option value="<?php echo $row_Recordset2['CRIME_TYPE']?>"><?php echo $row_Recordset2['CRIME_TYPE']?></option>
    <?php
